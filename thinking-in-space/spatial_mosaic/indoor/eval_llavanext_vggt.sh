#export CUDA_VISIBLE_DEVICES="2,3" # If you have multiple GPUs, you can set the actual GPU IDs, e.g., "0,1,2"
...
accelerate launch \
    ...
    --tasks ${THINKING_IN_SPACE_DIR}/lmms_eval/tasks/spatial_mosaic/indoor \
    --batch_size 1 \
    --log_samples \
    --log_samples_suffix llavanext_vggt_indoor \
    --output_path logs/llavanext_vggt_indoor_mosaic_indoor
